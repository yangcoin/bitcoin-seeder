...
class cloudflare_api
{
     ...
     */
    public function rec_new($domain, $type, $name, $content, $ttl = 1, $mode = 0, $prio = 1, $service = 0, $srvname = 1, $protocol = 1, $weight = 1, $port = 1, $target = 1)
    {
        $data = array(
            'a'       => 'rec_new',
            'z'       => $domain,
     ...
     * See http://www.cloudflare.com/docs/client-api.html#s5.1 for documentation.
     */
    public function rec_edit($domain, $type, $id, $name, $content, $ttl = 1, $mode = 0, $prio = 1, $service = 0, $srvname = 1, $protocol = 1, $weight = 1, $port = 1, $target = 1)
    {
        $data = array(
            'a'       => 'rec_edit',
            'z'       => $domain,
